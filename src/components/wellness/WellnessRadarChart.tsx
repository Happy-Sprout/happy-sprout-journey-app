...
const WellnessRadarChart = ({ journalEntry, loading = false, className }: WellnessRadarChartProps) => {
      ...
      <Card className={cn("bg-white shadow-sm", className)}>
        <CardContent className="p-4">
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <p className="text-gray-400 text-sm mt-2">Complete your daily journal to see your wellness snapshot.</p>
          </div>
        </CardContent>
      </Card>
    );
    ...
    <Card className={cn("bg-white shadow-sm", className)}>
      <CardContent className="p-4">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
          <h3 className="text-lg font-medium">Today's Wellness</h3>
